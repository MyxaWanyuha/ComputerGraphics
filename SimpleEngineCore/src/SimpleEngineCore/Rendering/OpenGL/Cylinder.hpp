...
{
public:
    Cylinder(const GLfloat height = 1.f, const float r = 0.5f, const float cx = 0, const float cy = 0, const float cz = 0, const u32 num_segments = 30, const glm::vec3& color = { 1, 1, 1 });
    void rotate_render(glm::vec3 axis = { 1.f,0.f,0.f }, float angle = 0.01f);
    void render();
