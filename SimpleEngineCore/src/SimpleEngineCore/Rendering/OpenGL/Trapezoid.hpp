...
{
public:
    Trapezoid(const GLfloat height = 1.f, const float up_length = 0.5f, const float down_length = 1.0f, const glm::vec3& color = { 1, 1, 1 });
...
private:
    float rotAngle = 0;
    void generate(const GLfloat height, const float up_length = 0.5f, const float down_length = 1.0f);
